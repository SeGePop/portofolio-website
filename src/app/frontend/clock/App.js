...
import "./styles.css";
import pauseIcon from "./icons/pause-play.svg";
import replayIcon from "./icons/replay.svg";
import upIcon from "./icons/up-arrow.svg";
import downIcon from "./icons/down-arrow.svg"
      ...
      <div className="app-wrapper">
        ...
        <div className="break-container">
          ...
          <div className="break-buttons">
            <div id="break-increment" onClick={this.handleClick.bind(this)}>
              ...
              <Image src={upIcon} alt="up" className="buttons" />
            </div>
            <div id="break-length">
            ...
            <div id="break-decrement" onClick={this.handleClick.bind(this)}>
              ...
              <Image src={downIcon} alt="down" className="buttons" />
            </div>
          </div>
        </div>
        {/* session section */}
        <div className="session-container">
          ...
          <div id="session-increment" onClick={this.handleClick.bind(this)}>
            {/* <UpIcon className="buttons" /> */}
            <Image src={upIcon} alt="up" className="buttons" style={{
              "fill":"#00ff00"
            }} />
          </div>
        ...
        <div className="timer-container">
          ...
          <div className="timer-buttons">
            ...
            >
              ...
              <Image src={pauseIcon} alt="down" className="buttons" />
            </div>
            <div
              id="reset"
              className="reset"
            ...
            >
              ...
              <Image src={replayIcon} alt="down" className="buttons" />
            </div>
          </div>
        </div>        
      </div>
